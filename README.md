...
````
		...
		of loader is changed to "overlay hidden" . "hidden" class hides the loader after the webpage is loaded .
       	...
       	2)
       		a) This function is used to make operations on datepicker in survey form and decide what will be the value of the datepicker .
        ...
        7)
         	a) This function is used when a user hover over the element with id "developer" it changes css of element whose id is "profile" and according to width also it changes the css .
